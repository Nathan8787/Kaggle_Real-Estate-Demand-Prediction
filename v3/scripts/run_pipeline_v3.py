...
from src.features_v3 import build_feature_matrix_v2
from src.predict_v3 import generate_predictions
from src.automl_runner_v3 import run
from walk_forward_train_v3 import walk_forward
...
def walk_forward_train_v3(args: argparse.Namespace) -> None:
    walk_forward(args)
...
def main() -> None:
    ...
    panel_parser.add_argument("--data-config", default="config/data_paths_v3.yaml")
    ...
    automl_parser.add_argument("--config", default="config/automl_v3.yaml")
    ...
    predict_parser.add_argument("--output-path", default="submission/submission_v3.csv")
    ...
    walk_parser = subparsers.add_parser("walk_forward_train_v3")
    walk_parser.add_argument("--panel-path", default="data/processed/panel_v3.parquet")
    walk_parser.add_argument("--features-path", default="data/processed/features_v3.parquet")
    walk_parser.add_argument("--config", default="config/automl_v3.yaml")
    walk_parser.set_defaults(func=walk_forward_train_v3)
